	...
	<div class="col-12 col-sm-6 d-flex align-items-center justify-content-end">
		<div class="float-right">
			<?php if (session()->get('log_role') === "ADMIN") : ?>
				<a href="<?= base_url('export/kunjungan') ?>" class="btn btn-success  mb-sm-0 mx-auto ml-sm-auto mr-sm-0">
					<i class="material-icons">add</i> Export Excel
				</a>
			<?php endif; ?>

			<?php if (session()->get('log_role') === "ADMIN" || session()->get('log_role') === "PASIEN") : ?>
				<a href="<?= base_url('appointment/form') ?>" class="btn btn-primary mb-sm-0 mx-auto ml-sm-auto mr-sm-0">
