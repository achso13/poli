<?= form_open('pengumuman/update') ?>
<?= csrf_field() ?>
<input type="hidden" name="f_id" value="<?= $result['id_pengumuman'] ?>">
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Pengumuman Update</h5>
    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
</div>
<div class="modal-body">
    <div class="form-group">
        <label>Judul<span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="f_judul" placeholder="Judul pengumuman" value="<?= $result['judul'] ?>">
        <div class="invalid-feedback"></div>
    </div>
    <div class="form-group">
        <label>Isi<span class="text-danger">*</span></label>
        <textarea class="form-control" name="f_isi" id="" cols="30" rows="10"><?= $result['isi'] ?></textarea>
        <div class="invalid-feedback"></div>
    </div>
</div>
