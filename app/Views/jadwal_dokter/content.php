                ...
                <?php foreach ($result as $row) : ?>
                    <tr>
                        ...
                        <td width="25%">
                            ...
                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modals-delete-<?= $row['id_jadwal_dokter'] ?>">
                                <i class="mr-1 fa fa-trash-alt"></i> Delete
                            </button>
                            <div class="modal fade" id="modals-delete-<?= $row['id_jadwal_dokter'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                <div class="modal-dialog " role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <?= form_open('doctor/jadwal/delete/' . $row['id_jadwal_dokter']) ?>
                                            <?= csrf_field() ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btn-add').click(function() {
            $('.load-form').load(base_url + '/doctor/jadwal/add');
        });
        ...
        $('.btn-edit').click(function() {
            ...
            $('.load-form').load(base_url + '/doctor/jadwal/edit/', {
                id: id
            });
        });
