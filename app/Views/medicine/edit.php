...
<div class="modal-body">
    ...
    <div class="form-group">
        <label>Masa Kadaluarsa<span class="text-danger">*</span></label>
        <input type="date" class="form-control" name="f_masa_kadaluarsa" value="<?= $result['masa_kadaluarsa'] ?>" placeholder="Masa kadaluarsa obat">
        <div class="invalid-feedback"></div>
    </div>
