            ...
            <table class="table table-bordered table-hover" width="100%" cellspacing="0" id="dataTable">
                <thead>
                    <tr class="bg-light">
                        ...
                        <td class="text-primary text-center" width="30%">Description</td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <?= form_open('medicine/delete/' . $row['id']) ?>
                                                <?= csrf_field() ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.btn-add').click(function() {
            $('.load-form').load(base_url + '/medicine/add');
        });

        $('.btn-edit').click(function() {
            var id = $(this).attr('uc');

            $('.load-form').load(base_url + '/medicine/edit', {
                id: id
            });
        });
