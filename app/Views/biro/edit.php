<?= form_open('unitkerja/biro/update') ?>
<?= csrf_field() ?>
<input type="hidden" name="f_id" value="<?= $result['id_biro'] ?>">
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Biro Update</h5>
    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
</div>
<div class="modal-body">
    <div class="form-group">
        <label>Nama Biro<span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="f_nama_biro" value="<?= $result['nama_biro'] ?>" placeholder="Nama kliniknya">
