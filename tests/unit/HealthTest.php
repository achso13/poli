 ...
 * @internal
 */
final class HealthTest extends CIsatuanTestCase
{
    ...
    public function testBaseUrlHasBeenSet()
    {
        ...
        if ($env) {
            ...
            // phpsatuan.xml.dist sets app.baseURL in $_SERVER
        ...
        // You can't use Config\App, because phpsatuan.xml.dist sets app.baseURL
